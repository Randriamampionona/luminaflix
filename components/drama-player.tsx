  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in duration-1000">
      ...
      <div className="flex items-end flex-col space-y-2">
        <div className="relative aspect-video max-h-[60vh] md:max-h-[69vh] w-full overflow-hidden bg-black border border-white/10 shadow-[0_0_80px_-20px_rgba(0,0,0,1)] ring-1 ring-white/5 group">
