        ...
        {isUnlocked && activeSource.isExternal && !showTheater && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-zinc-950 px-6">
            ...
            <div className="text-center space-y-8 relative z-10">
              <div className="relative w-24 h-24 mx-auto bg-black border border-white/10 rounded-3xl rotate-12 flex items-center justify-center group-hover:rotate-0 transition-transform duration-700">
              ...
              >
                <div className="flex items-center gap-3 relative z-10 uppercase text-xs tracking-widest">
