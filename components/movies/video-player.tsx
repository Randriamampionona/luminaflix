...
export default function VideoPlayer({
  ...
  const AD_URL =
    "https://creamymouth.com/dymxFCzud.GtNWvyZBG-UV/gewm/9WueZcUBlTktPlT/Yk4tMGDGkW2MMgjLUOtfNWjTg/wiOZT/YsyuOvQA";
  ...
  // Timer logic - Checks if video is actually playing
  useEffect(() => {
  ...
  // Watchdog Timer logic - Triggers if ad fails to start
  useEffect(() => {
